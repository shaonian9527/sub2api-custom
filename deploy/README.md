...
curl -sSL https://raw.githubusercontent.com/shaonian9527/sub2api-custom/main/deploy/docker-deploy.sh | bash

# Or download first, then run
curl -sSL https://raw.githubusercontent.com/shaonian9527/sub2api-custom/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/shaonian9527/sub2api-custom/releases)
